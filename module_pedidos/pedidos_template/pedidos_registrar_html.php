                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseVentas" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../pedidos_template/pedidos_registrar_html.php">Registrar Pedidos</a>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Detalle de pedido</label>

                                    ...
                                    <tbody>
                                      <?php foreach($data["Detalles"] as $pedidos): ?>
                                        <tr>
                                            ...
                                            <td><a href="pedidos_editar_html.php?ped_id=<?= $pedidos['ped_id'] ?>" class="btn btn-warning">Editar</a></td>
                                            <td><a href="pedidos_eliminar_html.php?ped_id=<?= $pedidos['ped_id'] ?>" class="btn btn-danger">Eliminar</a></td>
                                        </tr>
                                      <?php endforeach ?>
                                    </tbody>
                                </table>
